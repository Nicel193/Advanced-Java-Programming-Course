package kukuiev.advjava.labfirst.taskfirst;
...
public class PsychologistWithLocalization extends PsychologistWithList {
    ...
    /**
     * Find receptions by matching a word in a comment
     *
     * @param text on which we will find comments
     * @return receptions in the comments of which the word was found
     */
    ...
    /**
     * @return Minimum number of days between periods
     */
